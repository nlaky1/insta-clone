      ...
      <div className="mx-5 flex max-w-6xl justify-between lg:mx-auto">
        ...
        <div className="max-w-xs">
          <div className="relative mt-1 rounded-md p-3">
            ...
            <input
              className="sm:tex-sm block w-full rounded-md border-gray-300 bg-gray-50
          ...
          {session ? (
            <>
              <div className="navBtn relative">
                ...
                <div
                  className="absolute -top-2 -right-3 flex h-5 w-5
               animate-pulse items-center justify-center rounded-full bg-red-500 text-xs text-white "
                >
                  3
                </div>
              </div>
